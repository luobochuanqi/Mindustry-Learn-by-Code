...
class DuoModel : GeoModel<DuoTurretBlockEntity>() {
    ...
    companion object {
        val MODEL_RESOURCE = ResourceLocation.fromNamespaceAndPath(MTurrets.MOD_ID, "geo/duo.geo.json")
        val TEXTURE_RESOURCE = ResourceLocation.fromNamespaceAndPath(MTurrets.MOD_ID, "textures/block/duo.png")
        val ANIMATION_RESOURCE =
            ResourceLocation.fromNamespaceAndPath(MTurrets.MOD_ID, "animations/duo.animation.json")
    }
