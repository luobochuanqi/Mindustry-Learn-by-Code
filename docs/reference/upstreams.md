...
刷新:`git -C ref/<repo> fetch --depth 1 origin <branch> && git -C ref/<repo> reset --hard origin/<branch>`
...
- **Create** 分层:`src/main/java/**` 为 MIT(可借鉴);`src/main/resources/assets/**` 为 All Rights Reserved,**不得**复制贴图、模型、语言文件

## 在线参考文档

Mindustry Javadoc <https://mindustrygame.github.io/docs/>,Wiki <https://mindustrygame.github.io/wiki/>(炮台页 `wiki/blocks/349-duo/` 等)。
